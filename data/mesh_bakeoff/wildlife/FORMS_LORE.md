...
find them. Their oil-rich blubber renders straight into power cells;
cloud-whaling crews sing about good pods for years after."*
The herd animal of the argon clouds, and the closest thing the deep
sky has to livestock you'd recognize — found by ear before eye, since a
pod never stops calling.
- **Changed:** blowhole and lungs became a flow-through siphon gallery
  ...
  insulation, armor and, rendered, a power cell.
- **Feeds:** rows of glowing electrostatic baleen vents along the jaw
  charge the argon and comb the ionized fraction inward — it inhales
  its pasture, nose-to-fluke behind the pod leader, and the pod's wake
  is a clean lane through the cloud.
- **Defends:** the pod. Adults ring the calves and vent stored gas in
  ...
  tumbling. The contact calls that hold the pod together are also what
  gives it away to whaling crews, who sing about good pods for years.
...
- **Changed:** water-jet propulsion became a hydrogen-filled bell that
  rides the cloud currents instead of fighting them; the bell membrane
...
- **Feeds:** trails its crystalline cilia as a charged drift-net that
  strains trace nutrients, aerosol ice and organics from the murk,
  spiraling the catch up into the glowing core to be digested by slow
  light.
- **Defends:** transparency, numbers, and worthlessness — break one and
  the bell collapses in a puff of gas, and the whole shoal does the same
  a heartbeat later, leaving a predator a mouthful of cold hydrogen and
  a cloud with nothing in it. Shoals cover whole cloud systems and simply
  re-form. The amber cores, though, are why jelly-tenders exist.
...
*Codex (scanned, v0.571.0): "Broad and slack-winged, it lets the argon
banks carry it, filter-fronds trailing as it strains the inert gas from the
drift without ever seeming to work at it. A shadow or a charging weapon and
it folds and slides away edge-on, lost in the haze inside a breath. A bank
...
- **Changed:** cartilage became a rigid-light spar lattice; the wing
  became a slack solar-and-static membrane that the argon banks carry
  and that trickle-charges the animal as it drifts; gills became a wide
  intake scoop trailing filter-fronds.
- **Feeds:** lets the bank do the flying and strains the inert argon
  from the drift through its trailing fronds without ever seeming to
  work at it; a bank strained clear is a bank it has already left.
- **Defends:** the bioluminescent spot-rows are a counting trick —
  they fire in patterns that make one ray read as three on a
  predator's motion sense. Failing that, a shadow or a charging weapon
  and it folds, slides away edge-on and is lost in the haze inside a
  breath.
