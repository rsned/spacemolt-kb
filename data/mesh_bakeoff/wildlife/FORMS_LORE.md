...
- **Rock and ice are solid.** Belt and ice-field species have limbs that
  ...
  and walking gaits are the wrong picture for open space — a stock grazer
  is a beast latched onto a rock, not standing on one. Ice FIELDS are the
  exception the codex confirms: they are surfaces, and things walk, crawl
  and skim across them (the Hollow Pilgrim on its stilts, the Frost-Moth on
  its wings, the Pressblister crawling) — contact with a solid, not flight
  in a vacuum.
...
long enough. Where a belt's iron runs thin the herd drifts on, and a worked-
out field loses its grazers for good."*
...
- **Changed:** lungs traded for sealed fermentation stomachs; the muzzle
  became a fan of filter-plates that spread wide to comb dust; skin became a
  shell the animal packs with the iron it strains, so the plating is diet
...
- **Defends:** nothing on purpose. The armor is a by-product of eating, not
  a weapon; threatened, it clamps down, seals, and is a rock, and the herd
  scatters in all directions so a predator gets one, not five. Ranch brands
  don't change that math.
...
the same thing. Strike it and it withdraws into that shell and waits; it has
nowhere to be."*
Half again a belt-grazer's bulk and a fraction of its hurry.
- **Changed:** shell fused into a single dome of foamed slag and raw iron,
  half rust, half metal, meters thick in places — the animal secretes it
  molten and lets vacuum freeze it. There is no molt; what it ate and what
  it grew are the same thing, poured on a layer at a time.
- **Feeds:** plows through ferrous rubble and swallows rock whole, an under-
  slung furnace mouth cooking the ore loose at contact temperature and
  venting the slag behind it in a steady trail.
...
*Codex (scanned, v0.571.0): "Sociable, argon-grazing whales that travel in
big huntable pods, leading each other nose-to-fluke through the murk. A pod
is never silent — they keep constant contact calls, which is also how you
find them. Their oil-rich blubber renders straight into power cells; cloud-
whaling crews sing about good pods for years after."*
The herd animal of the argon clouds, and the closest thing the deep sky has
to livestock you'd recognize — found by ear before eye, since a pod never
stops calling.
- **Changed:** blowhole and lungs became a flow-through siphon gallery — the
  animal never holds breath because it never stops breathing cloud; blubber
  became a layered gas-bladder hull that is buoyancy, insulation, armor and,
  rendered, a power cell.
- **Feeds:** rows of glowing electrostatic baleen vents along the jaw charge
  the argon and comb the ionized fraction inward — it inhales its pasture,
  nose-to-fluke behind the pod leader, and the pod's wake is a clean lane
  through the cloud.
- **Defends:** the pod. Adults ring the calves and vent stored gas in a
  coordinated squall that blinds sensors and shoves small predators
  tumbling. The contact calls that hold the pod together are also what gives
  it away to whaling crews, who sing about good pods for years.

**Bell-Jelly** *(gas_cloud · grazer)*
*Codex (scanned, v0.571.0): "Fills its bell with hydrogen and rides the
cloud currents, straining trace nutrients through trailing cilia. Shoals of
them cover whole cloud systems. Break one and the bell collapses in a puff
of gas — which is what the rest of the shoal does immediately after."*
A drifting glass bell with an amber heart, harmless in every way that
matters and famous in every galley that matters.
- **Changed:** water-jet propulsion became a hydrogen-filled bell that rides
  the cloud currents instead of fighting them; the bell membrane became a
  one-molecule-thick pressure vessel that flexes instead of freezing; the
  sting was traded away entirely.
- **Feeds:** trails its crystalline cilia as a charged drift-net that
  strains trace nutrients, aerosol ice and organics from the murk, spiraling
  the catch up into the glowing core to be digested by slow light.
- **Defends:** transparency, numbers, and worthlessness — break one and the
  bell collapses in a puff of gas, and the whole shoal does the same a
  heartbeat later, leaving a predator a mouthful of cold hydrogen and a
  cloud with nothing in it. Shoals cover whole cloud systems and simply re-
  form. The amber cores, though, are why jelly-tenders exist.
...
**Drift-Ray** *(gas_cloud · grazer · ranchable)*
*Codex (scanned, v0.571.0): "Broad and slack-winged, it lets the argon banks
carry it, filter-fronds trailing as it strains the inert gas from the drift
without ever seeming to work at it. A shadow or a charging weapon and it
folds and slides away edge-on, lost in the haze inside a breath. A bank
strained clear of argon is a bank it has already left."*
The glider of the cloud margins, all wing and no hurry.
- **Changed:** cartilage became a rigid-light spar lattice; the wing became
  a slack solar-and-static membrane that the argon banks carry and that
  trickle-charges the animal as it drifts; gills became a wide intake scoop
  trailing filter-fronds.
- **Feeds:** lets the bank do the flying and strains the inert argon from
  the drift through its trailing fronds without ever seeming to work at it;
  a bank strained clear is a bank it has already left.
- **Defends:** the bioluminescent spot-rows are a counting trick — they fire
  in patterns that make one ray read as three on a predator's motion sense.
  Failing that, a shadow or a charging weapon and it folds, slides away
  edge-on and is lost in the haze inside a breath.
...
**Frost-Moth** *(ice_field · grazer)*
*Codex (scanned, v0.571.0): "Skims helium ice on pale wings, drawing the
superfluid into an abdomen that swells noticeably as it feeds. When a shoal
is disturbed it erupts — not fast, but in every direction at once, which
amounts to the same thing."*
A pale, papery grazer of the helium fields, met as a shoal resting on the
ice and remembered as the shoal leaving.
- **Changed:** the wing is a skimming surface, not an aerofoil — broad pale
  membranes that ride the ice on a film of boiled-off helium the way a
  hovercraft rides its skirt; the abdomen became a sac that takes the
  superfluid straight in and swells visibly with it.
- **Feeds:** skims helium ice, drawing the superfluid up into the abdomen
  until it is round and taut, then rests on the field to digest.
- **Defends:** the shoal erupts. Not fast — nothing on the ice is — but in
  every direction at once, which for a predator that came for one amounts to
  the same thing.

**Hollow Pilgrim** *(ice_field · grazer)*
*Codex (scanned, v0.571.0): "Walks ice ridges on hollow stilts, drawing
meltwater up through each leg and filtering it through internal membrane
stacks. It moves between fields in slow, purposeful processions that early
explorers mistook for migrations of something far more intelligent. Each
pass leaves a small, clear water crystal on the ice behind it."*
The tall, cowled walker of the ridges, and the reason early survey logs are
full of "processions".
- **Changed:** legs became hollow stilts that are also drinking straws —
  meltwater is drawn up through each one into stacks of filter membranes
  inside the shell-body; the body itself is a hollow cowl of pale bone
  plates around those stacks, which is why it scans empty.
- **Feeds:** walks the ridges where ice is thinnest, drawing meltwater up
  through its stilts and filtering it clean; what it cannot use it leaves
  behind as a small, clear water crystal on the ice, one per pass.
- **Defends:** procession. It does not run and does not fight; it keeps
  walking, slow and purposeful, in single file with its kind, and looks
  enough like something intelligent that most things leave it alone.

**Pressblister** *(ice_field · grazer)*
*Codex (scanned, v0.571.0): "A bloated bladder-creature that crawls
nitrogen-ice fields, boiling the ice inside a pressurized sac until it
swells pale and taut. Frontier miners call them pressblisters — a blister
that might pop at any moment, walking toward your boot. When threatened, it
vents the gas in a defensive burst and bolts."*
A walking blister, the miners' name and the accurate one.
- **Changed:** the gut became a pressurized sac that boils nitrogen ice into
  gas and holds it; the hide stretched over it pale and taut, domed and
  blistered; the limbs became rows of stubby feet for crawling the field.
- **Feeds:** crawls nitrogen-ice fields, taking the ice in and boiling it
  inside the sac until the whole animal swells, then lives on the gas.
- **Defends:** pops on purpose — vents the sac in a defensive burst of
  nitrogen that throws off a predator's aim, and bolts, deflated, while the
  cloud clears.

**Rime-Grazer** *(ice_field · grazer · ranchable)*
*Codex (scanned, v0.571.0): "It grinds the nitrogen fields, boiling the
frozen ice in its gut and venting a thick crust of refrozen nitrogen until
the rime buries whatever's underneath. It doesn't register threats until
something physically hits it, and even then it mostly just keeps moving.
Strip the nitrogen ice from a field and it lumbers off to the next."*
The ice-field stock animal: a rotund, frost-coated manatee that grinds
nitrogen ice and wears the leftovers.
- **Changed:** the grinding muzzle became a broad rasp-plated maw for
  nitrogen ice; the gut a boiler; the hide a venting surface — what it
  breathes out refreezes on it as a thick crust of rime, and a mature grazer
  is buried in its own exhaust.
- **Feeds:** grinds the nitrogen fields, boiling the ice in its gut, and
  lumbers off to the next field when one is stripped bare.
- **Defends:** does not. It does not register a threat until something
  physically hits it, and even then it mostly just keeps moving; the rime
  crust takes the hit. Ranchers love it for exactly this.
